...
class ConvNetParams:
    ...
    trainable_layers = {"down_conv_0": True, "down_conv_1": False, "down_conv_2": False, "down_conv_3": False,
                        "down_conv_4": False,
                        # up_conv consists of transpose cond and two convolutions
                        "up_conv_3": [False, False], "up_conv_2": [False, False], "up_conv_1": [False, False], "up_conv_0": [False, False],
                        "classifier": False}
...
class TrainingParams:
    ...
    # dropout probability fr the second convolution in each block
